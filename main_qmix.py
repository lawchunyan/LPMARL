...
if test:
    ...
    if use_wandb:
        wandb.init(project='optmarl', name=date.today().isoformat() + '-Qmix_mac')
batch_size = 20

agent = QAgent(state_dim, action_dim, n_agents, batch_size=batch_size, state_shape=env.get_state_size())
